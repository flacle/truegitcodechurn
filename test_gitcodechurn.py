...
MOCK_DATA = [
    (
        "febc94587dd7623832f10259c5dc8177fec50ae7",
        {
            ...
            "files": {"gitcodechurn.py": {0: 0, 1: 190}},
            "contribution": 190,
            "churn": 0,
        },
    ),
        ...
        "667dab70fccb844d65f439149fddfce2702d2e91",
        {
            ...
            "files": {
                "gitcodechurn.py": {
                    ...
                    52: 1,
                    55: 1,
                    # It appears the churn is on line 57
                    # as it is an add and then delete
                    # Ideally, this data structure would
                    # show line 57 was both deleted and extended
                    57: 9,
                    62: 1,
                    64: 1,
                    66: 2,
    ...
    (
        "617c2c27d5492e7ff782856d244d4d0eb0432a47",
        {
            ...
            "files": {
                "README.md": {15: 0, 24: 0, 31: 0, 35: 0, 41: 12},
                "gitcodechurn.py": {
                    11: -1,
                    15: 6,
                    16: 5,
...
def test_get_loc_change():
    ...
    The logic here is the left side is lines removed
    the right side is lines added.

    If no number is given after the comma, it is assumed to be 1
    """
    tests = [
        ("-11,0 +12,2", {11: 0, 12: 2}),
        ("-16 +18", {16: 1, 18: 1}),
        ...
        # it returns a dictionary where left are removals and right are additions
        # There's a bug here as dictionaries are non-ordered structures
        # Note how the "left" negative appears to the right in the dictionary result
        ("-80 +79,0", {79: 0, 80: 1}),
        ("-81,0 +81", {81: 1}),
        ("-103,2 +103,3", {103: 1}),
        ("-223 +224", {223: 1, 224: 1}),
